...
SETTING_HELP_TEXT: dict[SettingKey, str] = {
    ...
    SettingKey.FTP_HOST_INFO: "Enter in camera FTP server field",
    ...
    SettingKey.SYSTEM_OS_VERSION: "Operating system version",
    SettingKey.SYSTEM_POWER_INFO: "Bridge power hardware",
    ...
    SettingKey.FONT_SIZE: "Small / Medium / Large display font",
